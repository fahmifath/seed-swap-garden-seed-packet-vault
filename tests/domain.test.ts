...
const gi=(o:Partial<RawInput>={}):RawInput=>({plantName:"Cherry Tomato – Sun Gold",source:"bought",packetYear:"2027",quantity:"full",notes:"great germination",...o});
const gm=(o:Partial<SeedItem>={}):SeedItem=>({id:"abc-123",plantName:"Cherry Tomato – Sun Gold",source:"bought",packetYear:2027,quantity:"full",notes:"great germination",createdAt:"2025-01-01T00:00:00.000Z",...o});
...
describe("normalize – non-object raw shapes",()=>{
  ...
  it("rejects bare string",()=>norm("Cherry Tomato").toBeNull());
...
describe("normalize – valid shapes",()=>{
  it("normalizes well-formed stored item",()=>{expect(normalize(gm())?.plantName).toBe("Cherry Tomato – Sun Gold");});
